            ...
            <?php
                if (isset($_SESSION['perfil']) == 1) {
                    ...
                    if (isset($_REQUEST['borrar'])) {
                        $fila = borrarVenta($_REQUEST['borrar']);
                        if ($fila) {
                        ...
                        if(enviado() && validaModificar()){
                            $resultado=modificarVenta($_REQUEST['id'],$_REQUEST['fecha'],$_REQUEST['cantidad'],$_REQUEST['precio'],$_REQUEST['producto'],$_REQUEST['usuario']);
                            if($resultado){
                                header('Location:verVentas.php');
                                exit();
                            }else{
                            ...
                            if (enviado()) {
                                ...
                                if (vacio('producto')) {
                                    echo ">";
                                    array_push($errores,'Introduzca producto');
                                } else {
                                    if (!productoValido($_REQUEST['producto'])) {
                                        echo ">";
                                        array_push($errores,'Producto no existe');
