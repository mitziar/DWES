...
<body>
  ...
  <div class="jumbotron" style="background-color: bisque;">
    <div class="container">
      ...
      <h2>
        <center>Prácticas del Tema 5</center>
      </h2>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <h4><a href="../../">Tema5</a><a href="../">/Practicas</a><a href="index.php">/PR14</a>/ Leer Tabla</h4>
    </div>
                  ...
                  <td><a href='borrar.php?id=" . $value[0] . "'><input type='button' value='Borrar'></a></td></tr>";
                            ...
                            if (is_array($registros)) {
                              ...
                              foreach ($registros as $key => $value) {
                                ...
                                echo "<tr><td>" . $value[0] . "</td><td>" . $value[1] . "</td><td>" . $value[2] . "</td><td>" . $value[3] . "</td><td><a href='modificar.php?id=" . $value[0] . "'><input type='button' value='Modificar'></a></td></tr>";
                              }
                            }
                          } else {
                            if (is_array($registros)) {
                          ...
                          if (empty($registros)) {
                            echo "No existen registros para " . $_REQUEST['buscado'];
                          }
                          echo "</table>";
                        } else {
                          echo $cabecera;
