          ...
          */
           ...
           */
            ...
            */
            ...
            echo "<br> Cadena: ".str_replace('<'.'&lt',$cadena1)." y patron ".$patron. " Match ".preg_match($patron,$cadena1); 
            echo "<br> Cadena: ".str_replace('<'.'&lt',$cadena2)." y patron ".$patron. " Match ".preg_match($patron,$cadena2); 
            echo "<br> Cadena: ".str_replace('<'.'&lt',$cadena3)." y patron ".$patron. " Match ".preg_match($patron,$cadena3); 
            echo "<br> Cadena: ".str_replace('<'.'&lt',$cadena4)." y patron ".$patron. " Match ".preg_match($patron,$cadena4); 
